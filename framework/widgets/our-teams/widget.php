...
namespace FreskaElementorWidgets\Widgets\OurTeams;
...
class Widget_OurTeams extends Widget_Base
{
    ...
    protected function register_layout_section_controls()
    {
        ...
        $repeater->add_control(
            'image',
            [
                'label' => __('Team Member Image', 'freska'),
        ...
        $repeater->add_control(
            'facebook',
            [
                'label' => __('Facebook URL', 'freska'),
                'type' => Controls_Manager::URL,
                'placeholder' => __('https://facebook.com', 'freska'),
            ]
        );
        ...
        $repeater->add_control(
            'twitter',
            [
                'label' => __('Twitter URL', 'freska'),
                'type' => Controls_Manager::URL,
                'placeholder' => __('https://twitter.com', 'freska'),
            ]
        );
        ...
        $repeater->add_control(
            'pinterest',
            [
                'label' => __('Pinterest URL', 'freska'),
                'type' => Controls_Manager::URL,
                'placeholder' => __('https://pinterest.com', 'freska'),
            ]
        );
        ...
        $repeater->add_control(
            'instagram',
            [
                'label' => __('Instagram URL', 'freska'),
                'type' => Controls_Manager::URL,
                'placeholder' => __('https://instagram.com', 'freska'),
            ]
        );
        ...
        $this->add_control(
            'team_members',
            [
                'label' => __('Team Members', 'freska'),
                'type' => Controls_Manager::REPEATER,
                'fields' => $repeater->get_controls(),
                'default' => [
                    [
                        'name' => __('Team Member #1', 'freska'),
                        'position' => __('Developer', 'freska'),
                    ],
                    [
                        'name' => __('Team Member #2', 'freska'),
                        'position' => __('Designer', 'freska'),
                    ],
                ],
                'title_field' => '{{{ name }}}',
            ]
                                ...
                                <div class="bt-cover-image">
                                    ...
                                    if (!empty($member['image']['id'])) {
                                        ...
                                        if (!empty($member['image']['url'])) {
                                            echo '<img src="' . esc_url($member['image']['url']) . '" alt="'. esc_html__('Awaiting team member image', 'freska') . '">';
                                        } else {
                                            echo '<img src="' . esc_url(Utils::get_placeholder_image_src()) . '" alt="'. esc_html__('Awaiting team member image', 'freska') . '">';
                                        }
                                    }
                                    ?>
