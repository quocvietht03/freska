...
namespace FreskaElementorWidgets\Widgets\OurStore;
...
class Widget_OurStore extends Widget_Base
{
    ...
    protected function register_layout_section_controls()
    {
        ...
        $repeater->add_control(
            'name',
            [
                'label' => __('Store Name', 'freska'),
                'type' => Controls_Manager::TEXT,
                'default' => __('Store Name', 'freska'),
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'default' => __('123 Street Name, City, Country', 'freska'),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'default' => __('+1 234 567 890', 'freska'),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            'email',
            [
                'label' => __('Email', 'freska'),
                'type' => Controls_Manager::TEXT,
                'default' => __('store@example.com', 'freska'),
                'label_block' => true,
            ]
        );
        $repeater->add_control(
            'direction_text',
            [
                'label' => __('Direction Button Text', 'freska'),
                'type' => Controls_Manager::TEXT,
                'default' => __('Get Directions', 'freska'),
        ...
        $repeater->add_control(
            'direction_url',
            [
                'label' => __('Direction URL', 'freska'),
                'type' => Controls_Manager::URL,
                'placeholder' => __('https://maps.google.com/?q=...', 'freska'),
                'show_external' => true,
                'default' => [
                    'url' => '',
                    'is_external' => true,
        ...
        $this->add_control(
            'store_list',
            [
                'label' => __('Store List', 'freska'),
                'type' => Controls_Manager::REPEATER,
                'fields' => $repeater->get_controls(),
                'default' => [
                    [
                        'name' => __('Store #1', 'freska'),
                        'position' => __('Location 1', 'freska'),
                    ],
                    [
                        'name' => __('Store #2', 'freska'),
                        'position' => __('Location 2', 'freska'),
                    ],
                ],
                'title_field' => '{{{ name }}}',
            ]
    ...
    protected function register_style_section_controls()
    {
        ...
        $this->add_control(
            'direction_heading',
            [
                'label' => __('Direction Button', 'freska'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
                                ...
                                <div class="bt-cover-image">
                                    ...
                                    if (!empty($store['image']['id'])) {
                                        ...
                                        if (!empty($store['image']['url'])) {
                                            echo '<img src="' . esc_url($store['image']['url']) . '" alt="' . esc_html__('Awaiting store image', 'freska') . '">';
                                        } else {
                                            echo '<img src="' . esc_url(Utils::get_placeholder_image_src()) . '" alt="' . esc_html__('Awaiting store image', 'freska') . '">';
                                        }
                                    }
                                    ?>
                                </div>
