...
namespace FreskaElementorWidgets\Widgets\ProductShowcaseStyle1;
...
class Widget_ProductShowcaseStyle1 extends Widget_Base
{
	...
	{
		return __('Product Showcase Style 1', 'freska');
	}
	...
	protected function register_style_section_controls()
	{
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Product Title', 'freska'),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Product Price', 'freska'),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Product Short Description', 'freska'),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Variable Product', 'freska'),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Add to Cart Button', 'freska'),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
			...
			if ($query->have_posts()) :
				while ($query->have_posts()) : $query->the_post();
					...
					if (has_post_thumbnail($product_id)) {
						...
						$product_thumbnail = '<img src="' . esc_url(wc_placeholder_img_src('woocommerce_thumbnail')) . '" alt="' . esc_html__('Awaiting product image', 'freska') . '" class="wp-post-image" />';
					}
						...
						<div class="bt-col-product bt-product-showcase--item-content js-check-bg-color">
							...
							<div class="bt-product--infor">
								<div class="bt-product--info">
									...
									<?php endif; ?>
									<?php do_action('freska_woocommerce_show_product_loop_sale_flash'); ?>
								</div>
								...
								<?php endif; ?>
								<?php do_action('freska_woocommerce_template_single_countdown');  ?>
