...
namespace FreskaElementorWidgets\Widgets\InstagramPosts;
...
class Widget_InstagramPosts extends Widget_Base
{
	...
	{
		return __('Instagram Posts', 'freska');
	}
	...
	protected function register_content_section_controls()
	{
		...
		$this->add_control(
			'gallery',
			[
				'label' => esc_html__('Add Images', 'freska'),
		...
		$this->add_control(
			'open_type',
			[
				'label' => __('On Click', 'freska'),
				'type' => Controls_Manager::SELECT,
				'default' => 'popup',
				'options' => [
					'popup' => __('Popup', 'freska'),
					'link' => __('Link', 'freska'),
				],
				'description' => __('Choose what happens when an Instagram image is clicked: open in a popup or go to the Instagram link.', 'freska'),
			]
		);
		$this->add_control(
			'link',
			[
				'label' => __('Link', 'freska'),
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'tilted' => __('Tilted', 'freska'),
				],
				'description' => __('Choose the layout style for the Instagram posts.', 'freska'),
			]
		);
	...
	protected function register_style_content_section_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bt-icon-view svg' => 'color: {{VALUE}};', 
				],
			]
		);
		...
		$this->add_control(
			'icon_bg_color',
			[
				'label' => __('Icon Background', 'freska'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'icon_hover_color',
			[
				'label' => __('Icon Hover Color', 'freska'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bt-icon-view:hover svg' => 'color: {{VALUE}};',  
				],
			]
		);
		...
		$this->add_control(
			'icon_hover_bg_color',
			[
				'label' => __('Icon Hover Background', 'freska'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
								...
								<div class="bt-ins-posts--image">
									<div class="bt-cover-image">
										<?php if (!empty($item['id'])) {
											...
											echo '<img src="' . esc_url(Utils::get_placeholder_image_src()) . '" alt="' . esc_html__('Awaiting image', 'freska') . '">';
										} ?>
									</div>
									<?php 
