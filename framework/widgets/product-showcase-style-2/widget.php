...
namespace FreskaElementorWidgets\Widgets\ProductShowcaseStyle2;
...
class Widget_ProductShowcaseStyle2 extends Widget_Base
{
	...
	{
		return __('Product Showcase Style 2', 'freska');
	}
	...
	protected function register_layout_section_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'raw' => __('Select a layout in product edit page for this layout to work properly. Supported layouts are: bottom-thumbnail, left-thumbnail, right-thumbnail', 'freska'),
