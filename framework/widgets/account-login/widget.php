...
namespace FreskaElementorWidgets\Widgets\AccountLogin;
...
class Widget_AccountLogin extends Widget_Base
{
	...
	{
		return __('Account Login', 'freska');
	}
	...
	protected function register_content_section_controls()
	{
		$this->start_controls_section(
			'section_content',
			[
				'label' => esc_html__('Settings', 'freska'),
		...
		$this->add_control(
			'enable_popup',
			[
				'label' => esc_html__('Enable Popup Mode', 'freska'),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__('Yes', 'freska'),
				'label_off' => esc_html__('No', 'freska'),
				'return_value' => 'yes',
				'default' => 'no',
				'description' => esc_html__('Enable to show login form in popup instead of redirecting to login page', 'freska'),
			]
		);
		...
		$this->add_control(
			'hide_text',
			[
				'label' => esc_html__('Hide Text After Icon', 'freska'),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__('Yes', 'freska'),
				'label_off' => esc_html__('No', 'freska'),
				'return_value' => 'yes',
				'default' => 'no',
				'description' => esc_html__('Hide the text and show only the icon', 'freska'),
			]
		);
		...
		$this->add_control(
			'popup_title',
			[
				'label' => esc_html__('Login Title', 'freska'),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__('Log In', 'freska'),
				'condition' => [
					'enable_popup' => 'yes',
				],
			]
		...
		$this->add_control(
			'show_register_link',
			[
				'label' => esc_html__('Show Register Link', 'freska'),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__('Yes', 'freska'),
				'label_off' => esc_html__('No', 'freska'),
				'return_value' => 'yes',
		...
		$this->add_control(
			'register_title',
			[
				'label' => esc_html__('Register Title', 'freska'),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__('Create A Free Account', 'freska'),
				'condition' => [
					'enable_popup' => 'yes',
		...
		$this->add_control(
			'terms_url',
			[
				'label' => esc_html__('Terms of User URL', 'freska'),
				'type' => Controls_Manager::URL,
				'placeholder' => esc_html__('https://your-site.com/terms', 'freska'),
				'default' => [
					'url' => '',
					'is_external' => true,
					'nofollow' => false,
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bt-elwg-account-login .bt-account a svg' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->start_controls_section(
			'section_popup_style',
			[
				'label' => esc_html__('Popup Style', 'freska'),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'enable_popup' => 'yes',
				],
		...
		$this->add_control(
			'popup_width',
			[
				'label' => esc_html__('Popup Width', 'freska'),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px', '%'],
				'range' => [
					'px' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__('Box Shadow', 'freska'),
	...
	protected function render()
	{
		...
		$hide_text = $settings['hide_text'] === 'yes';
?>
					...
					<div class="bt-account bt-my-account">
						<?php if (class_exists('Woocommerce')) { ?>
							<a href="<?php echo esc_url(wc_get_page_permalink('myaccount')); ?>">
								...
								<?php if (!$hide_text) { ?>
									<?php esc_html_e('My Account', 'freska'); ?>
								<?php } ?>
							</a>
						<?php } else { ?>
							<a href="<?php echo esc_url(wp_logout_url()); ?>">
								...
								<?php if (!$hide_text) { ?>
									<?php esc_html_e('Sign Out', 'freska'); ?>
								<?php } ?>
							</a>
						<?php } ?>
					</div>
						...
						<div class="bt-popup-content">
							...
							<div class="bt-tab-content active" data-tab="login">
								...
								<div class="bt-form-group">
									<label for="bt-username-<?php echo esc_attr($widget_id); ?>"><?php esc_html_e('Username or email address', 'freska'); ?><span class="required">*</span></label>
									<input type="text" id="bt-username-<?php echo esc_attr($widget_id); ?>" name="username" class="bt-form-control" required>
								</div>
								
								<div class="bt-form-group">
									<label for="bt-password-<?php echo esc_attr($widget_id); ?>"><?php esc_html_e('Password', 'freska'); ?><span class="required">*</span></label>
									<div class="bt-password-wrapper">
										...
										<button type="button" class="bt-toggle-password" aria-label="<?php esc_attr_e('Show password', 'freska'); ?>">
								...
								<div class="bt-form-group bt-form-row">
									<label class="bt-checkbox-wrapper">
										...
										<?php esc_html_e('Remember me', 'freska'); ?>
									</label>
									<a href="<?php echo esc_url(wp_lostpassword_url()); ?>" class="bt-forgot-password"><?php esc_html_e('Forgot Your Password?', 'freska'); ?></a>
								</div>

								<div class="bt-form-group">
									<button type="submit" class="bt-login-btn"><?php esc_html_e('Login', 'freska'); ?></button>
								</div>
								...
								<?php if ($settings['show_register_link'] === 'yes') { ?>
									<div class="bt-register-link">
										<?php esc_html_e('Not registered yet?', 'freska'); ?> 
										<a href="#" class="bt-switch-to-register"><?php esc_html_e('Sign Up', 'freska'); ?></a>
									</div>
								<?php } ?>
							...
							<div class="bt-tab-content" data-tab="register">
								<form class="bt-register-form" method="post" data-widget-id="<?php echo esc_attr($widget_id); ?>">
									<div class="bt-form-group">
										<label for="bt-reg-username-<?php echo esc_attr($widget_id); ?>"><?php esc_html_e('Username', 'freska'); ?><span class="required">*</span></label>
										<input type="text" id="bt-reg-username-<?php echo esc_attr($widget_id); ?>" name="username" class="bt-form-control" required>
									</div>
									
									<div class="bt-form-group">
										<label for="bt-reg-email-<?php echo esc_attr($widget_id); ?>"><?php esc_html_e('Email address', 'freska'); ?><span class="required">*</span></label>
										<input type="email" id="bt-reg-email-<?php echo esc_attr($widget_id); ?>" name="email" class="bt-form-control" required>
									</div>
									
									<div class="bt-form-group">
										<label for="bt-reg-password-<?php echo esc_attr($widget_id); ?>"><?php esc_html_e('Password', 'freska'); ?><span class="required">*</span></label>
										<div class="bt-password-wrapper">
									...
									<div class="bt-form-group">
										<label for="bt-reg-confirm-password-<?php echo esc_attr($widget_id); ?>"><?php esc_html_e('Confirm password', 'freska'); ?><span class="required">*</span></label>
										<div class="bt-password-wrapper">
									...
									<div class="bt-form-group">
										<label class="bt-checkbox-wrapper">
											...
											<span class="bt-checkmark"></span>
											<?php esc_html_e('I agree to the', 'freska'); ?> 
											<?php 
											...
											if (!empty($terms_url['url'])) {
												...
												esc_html_e('Terms Of User', 'freska');
												echo '</a>';
											} else {
									...
									<div class="bt-form-group">
										<button type="submit" class="bt-register-btn"><?php esc_html_e('Create A New Account', 'freska'); ?></button>
									</div>

									<div class="bt-register-messages"></div>

									<div class="bt-login-link">
										<?php esc_html_e('Already have an account?', 'freska'); ?> 
										<a href="#" class="bt-switch-to-login"><?php esc_html_e('Login Here', 'freska'); ?></a>
									</div>
