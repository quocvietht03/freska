...
namespace FreskaElementorWidgets\Widgets\AccordionHotspot;
...
class Widget_AccordionHotspot extends Widget_Base
{
    ...
    {
        return __('Accordion Hotspot', 'freska');
    }
    ...
    protected function register_layout_section_controls()
    {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => '',
                'placeholder' => __('Enter title', 'freska'),
                'label_block' => true,
            ]
        );
        $repeater->add_control(
            ...
            [
                ...
                'default' => '',
                'placeholder' => __('Enter description', 'freska'),
                'label_block' => true,
            ]
        );
        $repeater->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'title' => esc_html__( 'Accordion Title #1', 'freska' ),
                        'desc'  => esc_html__( 'This is a short description for accordion item #1.', 'freska' ),
                        'hotspot_position_x' => [
                            'unit' => '%',
                            'size' => 10,
                        ],
                    ...
                    [
                        'title' => esc_html__( 'Accordion Title #2', 'freska' ),
                        'desc'  => esc_html__( 'This is a short description for accordion item #2.', 'freska' ),
                        'hotspot_position_x' => [
                            'unit' => '%',
                            'size' => 70,
                        ],
                    ...
                    [
                        'title' => esc_html__( 'Accordion Title #3', 'freska' ),
                        'desc'  => esc_html__( 'This is a short description for accordion item #3.', 'freska' ),
                        'hotspot_position_x' => [
                            'unit' => '%',
                            'size' => 50,
                        ],
