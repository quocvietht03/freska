...
namespace FreskaElementorWidgets\Widgets\LocationList;
...
class Widget_LocationList extends Widget_Base
{
    ...
    {
        return __('Location List', 'freska');
    }
    ...
    protected function register_layout_section_controls()
    {
        ...
        $this->add_control(
            'search_title',
            [
                'label' => __('Search Title', 'freska'),
                'type' => Controls_Manager::TEXT,
                'default' => __('Find A Location', 'freska'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            'search_subtitle',
            [
                'label' => __('Search Subtitle', 'freska'),
                'type' => Controls_Manager::TEXT,
                'default' => __('Locate Your Nearest Store or Showroom', 'freska'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            'search_placeholder',
            [
                'label' => __('Search Placeholder', 'freska'),
                'type' => Controls_Manager::TEXT,
                'default' => __('New York, NY, US', 'freska'),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => __('Our Locations', 'freska'),
            ]
        );
        $repeater->add_control(
            'location_address',
            [
                'label' => __('Address', 'freska'),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => '',
            ]
        ...
        $repeater->add_control(
            'location_button',
            [
                'label' => __('Button', 'freska'),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => __('Get direction', 'freska'),
            ]
        );
        $repeater->add_control(
        ...
        $repeater->add_control(
            ...
            [
                'label' => __('Open / Close', 'freska'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Open', 'freska'),
                'label_off' => __('Close', 'freska'),
                'return_value' => 'yes',
                'default' => 'yes',
            ]
        );
        $repeater->add_control(
            ...
            [
                'label' => __('Closing time note', 'freska'),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => __('(Close 6PM)', 'freska'),
                'placeholder' => __('e.g. Closes until 5:00 pm', 'freska'),
            ]
        );
        ...
        $this->add_control(
            'list',
            [
                'label' => __('Location list', 'freska'),
                'type' => Controls_Manager::REPEATER,
                'fields' => $repeater->get_controls(),
                'default' => [
                    [
                        'location_title' => __('Sydney Double Bay', 'freska'),
                        'location_address' => __('66 Broklyn New Golden Street USA', 'freska'),
                        'location_button' => __('Enquire', 'freska'),
                        'location_button_link' => '#',
                        'location_phone' => __('+1(800)123-4566', 'freska'),
                        'location_status_open' => 'yes',
                        'location_closes_until' => __('(Close 6PM)', 'freska'),
                        'location_maps_zoom' => '12',
                    ],
                    [
                        'location_title' => __('Newport Beach', 'freska'),
                        'location_address' => __('854 Avocado Ave. Street USA', 'freska'),
                        'location_button' => __('Enquire', 'freska'),
                        'location_button_link' => '#',
                        'location_phone' => __('+1(800)123-4566', 'freska'),
                        'location_status_open' => 'yes',
                    ...
                    [
                        'location_title' => __('Waikoloa, USA', 'freska'),
                        'location_address' => __('Waikoloa Beach Resort, Unit D-8 250 Waikoloa Beach', 'freska'),
                        'location_button' => __('Enquire', 'freska'),
                        'location_button_link' => '#',
                        'location_phone' => __('+1(800)123-4566', 'freska'),
                        'location_status_open' => 'yes',
    ...
    protected function register_style_section_controls()
    {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Search Header', 'freska'),
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __('Bottom Spacing', 'freska'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', 'em'],
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Subtitle', 'freska'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Search Input', 'freska'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Focus Border Color', 'freska'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Location Content', 'freska'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Address & Phone', 'freska'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Phone Hover Color', 'freska'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Status', 'freska'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'status_open_heading',
            [
                'label' => esc_html__('Open Indicator', 'freska'),
                'type' => Controls_Manager::HEADING,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Close Indicator', 'freska'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'status_text_heading',
            [
                'label' => esc_html__('Status Text (e.g. Closing time)', 'freska'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Direction Link', 'freska'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
                                ...
                                <div class="bt-location-status-wrapper">
                                    <div class="bt-location-status">
                                        ...
                                        <span class="bt-status-indicator <?php echo esc_attr($is_open ? 'open' : 'close'); ?>">
                                            <?php echo esc_html($is_open ? __('Open', 'freska') : __('Close', 'freska')); ?>
                                        </span>
