...
namespace FreskaElementorWidgets\Widgets\HeadingAnimation;
...
class Widget_HeadingAnimation extends Widget_Base
{
	...
	{
		return __('Heading Animation', 'freska');
	}
	...
	protected function register_content_section_controls()
	{
		...
		$this->add_control(
			'animation_text',
			[
				'label'       => esc_html__('Heading Animation', 'freska'),
				'type'        => Controls_Manager::TEXTAREA,
				'label_block' => true,
				'default'     => esc_html__('Animation', 'freska'),
			]
		);
		...
		$this->add_control(
			'entrance_animation',
			[
				'label' => esc_html__( 'Entrance Animation', 'freska' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'none',
				'options' => [
					'none' => esc_html__( 'None', 'freska' ),
					'bt-animation-right' => esc_html__( 'Fade In Right', 'freska' ),
					'bt-animation-left' => esc_html__( 'Fade In Left', 'freska' ),
					'bt-animation-up' => esc_html__( 'Fade In Up', 'freska' ),
					'bt-animation-down' => esc_html__( 'Fade In Down', 'freska' ),
					'bt-animation-zoom' => esc_html__( 'Zoom In', 'freska' ),
				],
			]
		);
		$this->add_responsive_control(
			'animation_delay',
			[
				'label' => __('Animation Delay (ms)', 'freska'),
	...
	protected function register_style_content_section_controls()
	{
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Heading', 'freska'),
