...
namespace FreskaElementorWidgets\Widgets\ProductSpotlightItem;
...
class Widget_ProductSpotlightItem extends Widget_Base
{
	...
	{
		return __('Product Spotlight Item', 'freska');
	}
	...
	protected function register_layout_section_controls()
	{
        ...
        $this->add_control(
            'featured_image',
            [
                'label' => __('Featured Image', 'freska'),
        ...
        $this->add_control(
            'image_overlay',
            [
                'label' => __('Enable Image Overlay', 'freska'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'freska'),
                'label_off' => __('No', 'freska'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                ...
                'description' => __('Enter video URL (Mp4)', 'freska'),
                'condition' => [
                    'video_type' => ['url'],
                    'enable_video' => 'yes',
                ],
        ...
        $this->add_control(
            'video_file',
            [
                'label' => __('Choose Video File (Mp4)', 'freska'),
                'type' => Controls_Manager::MEDIA,
                'media_type' => 'video',
                'condition' => [
                    'video_type' => 'file',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Enable Product Title Limit', 'freska' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'yes',
                'condition' => [
					'product_id!' => '',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Product Title Limit Lines', 'freska' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 1,
                    ...
                    <?php
                        if (!empty($settings['featured_image']['id'])) {
                            ...
                            if (!empty($settings['featured_image']['url'])) {
                                echo '<img src="' . esc_url($settings['featured_image']['url']) . '" alt="' . esc_html__('Awaiting testimonial image', 'freska') . '">';
                            } else {
