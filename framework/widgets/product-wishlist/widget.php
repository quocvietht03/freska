...
namespace FreskaElementorWidgets\Widgets\ProductWishlist;
...
class Widget_ProductWishlist extends Widget_Base
{
	...
	{
		return __('Product Wishlist', 'freska');
	}
					...
					<div class="bt-table--head">
						<div class="bt-table--row">
							<div class="bt-table--col bt-product-remove">
								<?php echo '<span>' . __('Remove', 'freska') . '</span>'; ?>
							</div>
							<div class="bt-table--col bt-product-thumb">
								<?php echo '<span>' . __('Thumbnail', 'freska') . '</span>'; ?>
							</div>
							<div class="bt-table--col bt-product-title">
								<?php echo '<span>' . __('Product Name', 'freska') . '</span>'; ?>
							</div>
							<div class="bt-table--col bt-product-price">
								<?php echo '<span>' . __('Price', 'freska') . '</span>'; ?>
							</div>
							<div class="bt-table--col bt-product-stock">
								<?php echo '<span>' . __('Stock status', 'freska') . '</span>'; ?>
							</div>
						...
						<?php } else { ?>
							<div class="bt-product-list">
								<div class="bt-no-results">
									<?php echo __('No products found!', 'freska'); ?>
									<a href="/shop/"><?php echo __('Back to Shop', 'freska'); ?></a>
								</div>
							</div>
						<?php } ?>
					</div>
