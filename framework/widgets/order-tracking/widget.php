...
namespace FreskaElementorWidgets\Widgets\OrderTracking;
...
class Widget_OrderTracking extends Widget_Base
{
	...
	{
		return __('Order Tracking', 'freska');
	}
	...
	protected function register_content_section_controls()
	{
		...
		$this->add_control(
			'note_text',
			[
				'label' => esc_html__('Note Text', 'freska'),
				'type' => Controls_Manager::TEXTAREA,
				'default' => __('To track your order please enter your Order ID in the box below and press the "Track" button. This was given to you on your receipt and in the confirmation email you should have received.', 'freska'),
				'rows' => 5,
			]
		);
		...
		$this->add_control(
			'order_id_label',
			[
				'label' => esc_html__('Order ID Label', 'freska'),
				'type' => Controls_Manager::TEXT,
				'default' => __('Order ID', 'freska'),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Order ID Placeholder', 'freska'),
				'type' => Controls_Manager::TEXT,
				'default' => __('Found in your order confirmation email.', 'freska'),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			'billing_email_label',
			[
				'label' => esc_html__('Billing Email Label', 'freska'),
				'type' => Controls_Manager::TEXT,
				'default' => __('Billing email', 'freska'),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Billing Email Placeholder', 'freska'),
				'type' => Controls_Manager::TEXT,
				'default' => __('Email you used during checkout.', 'freska'),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			'button_text',
			[
				'label' => esc_html__('Button Text', 'freska'),
				'type' => Controls_Manager::TEXT,
				'default' => __('Track', 'freska'),
				'label_block' => true,
			]
		);
	...
	protected function register_style_section_controls()
	{
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Button', 'freska'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
