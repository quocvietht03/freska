...
namespace FreskaElementorWidgets\Widgets\TestimonialSlider;
...
class Widget_TestimonialSlider extends Widget_Base
{
    ...
    {
        return __('Testimonial Slider', 'freska');
    }
    ...
    protected function register_layout_section_controls()
    {
        ...
        $repeater->add_control(
            'testimonial_image',
            [
                'label' => __('Testimonial Image', 'freska'),
        ...
        $this->add_control(
            ...
            [
                ...
                'description' => __('Select the position of the testimonial image relative to the content.', 'freska'),
            ]
        );
    ...
    protected function register_style_section_controls()
    {
        ...
        $this->add_responsive_control(
            'text_lines_number',
            [
                'label' => __('Number of Lines', 'freska'),
                'type' => Controls_Manager::NUMBER,
                'default' => 6,
                'min' => 1,
                'condition' => [
