...
namespace FreskaElementorWidgets\Widgets\PostGrid;
...
class Widget_PostGrid extends Widget_Base
{
	...
	protected function register_layout_section_controls()
	{
		...
		$this->add_control(
			'posts_per_page',
			[
				'label' => __('Posts Per Page', 'freska'),
	...
	protected function register_query_section_controls()
	{
		...
		$this->add_control(
			'offset',
			[
				'label' => __('Offset', 'freska'),
				'type' => Controls_Manager::NUMBER,
				'default' => 0,
				'description' => __('Use this setting to skip over posts (e.g. \'2\' to skip over 2 posts).', 'freska'),
			]
		);
		...
		$this->add_control(
			'orderby',
			[
				'label' => __('Order By', 'freska'),
				'type' => Controls_Manager::SELECT,
				'default' => 'post_date',
				'options' => [
					'post_date' => __('Date', 'freska'),
					'post_title' => __('Title', 'freska'),
					'menu_order' => __('Menu Order', 'freska'),
					'rand' => __('Random', 'freska'),
				],
			]
		);
	...
	protected function register_style_section_controls()
	{
		...
		$this->add_control(
			...
			[
				'label' => __('First Post Title', 'freska'),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __('First Post Date', 'freska'),
				'type' => Controls_Manager::HEADING,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __('First Post Excerpt', 'freska'),
				'type' => Controls_Manager::HEADING,
				'condition' => [
					'layout' => 'layout-02',
				],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Pagination', 'freska'),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'show_pagination!' => '',
				],
