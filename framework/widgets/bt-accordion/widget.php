...
namespace FreskaElementorWidgets\Widgets\BtAccordion;
    ...
    protected function register_layout_section_controls()
    {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'label_block' => true,
                'default' => __('Accordion Title', 'freska'),
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'label_block' => true,
                'default' => __('Accordion description content goes here.', 'freska'),
            ]
        );
        ...
        $this->add_control(
            'accordion_list',
            [
                'label' => __('Accordion Items', 'freska'),
                ...
                'default' => [
                    [
                        ...
                        'accordion_title' => __('What is BT Accordion?', 'freska'),
                        'accordion_description' => __('BT Accordion is a flexible and customizable accordion widget that allows you to create collapsible content sections with icons and descriptions.', 'freska')
                    ],
                    [
                        'accordion_icon' => [
                            'value' => 'fas fa-cog',
                        ...
                        'accordion_title' => __('How to customize?', 'freska'),
                        'accordion_description' => __('You can easily customize the accordion by adding your own icons, titles, and descriptions. Use the style controls to match your design.', 'freska')
                    ],
                    [
                        'accordion_icon' => [
                        ...
                        'accordion_title' => __('Need support?', 'freska'),
                        'accordion_description' => __('Our dedicated support team is here to help you with any questions or issues you might encounter.', 'freska')
                    ],
                ],
        ...
        $this->add_control(
            'open_first_item',
            [
                'label' => __('Open First Item', 'freska'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'freska'),
                'label_off' => __('No', 'freska'),
                'return_value' => 'yes',
                'default' => 'no',
                'description' => __('Open the first accordion item by default', 'freska'),
            ]
        );
    ...
    protected function register_style_section_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'description' => __('Set spacing between accordion items', 'freska'),
            ]
        );
