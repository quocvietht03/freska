...
namespace FreskaElementorWidgets\Widgets\ProductTestimonial;
...
class Widget_ProductTestimonial extends Widget_Base
{
    ...
    {
        return __('Product Testimonial', 'freska');
    }
    ...
    protected function register_layout_section_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __('Hear from Our Happy Customers', 'freska'),
                'placeholder' => __('Enter heading text', 'freska'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Description', 'freska'),
                'type' => Controls_Manager::TEXTAREA,
                'default' => __('Discover why our customers love their sleep experiences with us!', 'freska'),
                'placeholder' => __('Enter description text', 'freska'),
                'rows' => 3,
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXTAREA,
                'rows' => 5,
                'default' => __('Enter testimonial text here', 'freska'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'testimonial_text' => __('Great product! Highly recommend it.', 'freska'),
                    ],
                    [
                        'testimonial_text' => __('Excellent quality and fast delivery.', 'freska'),
                    ],
                    [
                        'testimonial_text' => __('Best purchase I made this year!', 'freska'),
                    ],
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => __('Testimonial Full Width', 'freska'),
                'description' => __('This should only be used in Elementor’s Full Width mode. Enter your site’s container width to ensure the content is aligned correctly with the layout.', 'freska'),
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __('Container Width', 'freska'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range' => [
                    'px' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __('Responsive Overlay Content', 'freska'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'freska'),
                'label_off' => __('No', 'freska'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => __('Background Overlay', 'freska'),
                'type' => Controls_Manager::COLOR,
                'default' => '#000',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __('Overlay Opacity', 'freska'),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 0.6,
                ],
        ...
        $this->add_control(
            'slider_autoplay',
            [
                'label' => __('Slider Autoplay', 'freska'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'freska'),
                'label_off' => __('No', 'freska'),
                'default' => 'no',
        ...
        $this->add_control(
            ...
            [
                ...
                'max' => 10000,
                'step' => 500,
                'description' => __('Delay between slides in milliseconds', 'freska'),
                'condition' => [
                    'slider_autoplay' => 'yes',
                ],
            ]
        ...
        $this->add_control(
            'slider_pagination',
            [
                'label' => __('Show Pagination', 'freska'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'freska'),
                'label_off' => __('No', 'freska'),
                'default' => 'no',
    ...
    protected function register_style_section_controls()
    {
        ...
        $this->add_control(
            'image_position',
            [
                'label' => __('Image Position', 'freska'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'row-reverse' => __('Left', 'freska'),
                    'row' => __('Right', 'freska'),
                ],
                'default' => 'row-reverse',
                'selectors' => [
        ...
        $this->add_control(
            'image_object_fit',
            [
                'label' => __('Image Object Fit', 'freska'),
                'type' => Controls_Manager::SELECT,
                'default' => 'cover',
                'options' => [
                    'cover' => __('Cover', 'freska'),
                    'contain' => __('Contain', 'freska'),
                    'fill' => __('Fill', 'freska'),
                    'none' => __('None', 'freska'),
                ],
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __('Image Background Color', 'freska'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'image_border_radius',
            [
                'label' => __('Image Border Radius', 'freska'),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Content Background Color', 'freska'),
                'type' => Controls_Manager::COLOR,
                'default' => '#FFFFFF',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __('Heading vs Description', 'freska'),
        ...
        $this->add_control(
            'description_color',
            [
                'label' => __('Description Color', 'freska'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
