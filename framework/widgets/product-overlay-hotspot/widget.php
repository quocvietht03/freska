...
namespace FreskaElementorWidgets\Widgets\ProductOverlayHotspot;
...
class Widget_ProductOverlayHotspot extends Widget_Base
{
    ...
    {
        return __('Product Overlay Hotspot', 'freska');
    }
    ...
    protected function register_layout_section_controls()
    {
        $this->start_controls_section(
            'section_content',
            [
                'label' => __('Hotspot Content', 'freska'),
            ]
        );
        ...
        $this->add_control(
            'hotspot_items',
            [
                'label' => __('Hotspot Points', 'freska'),
    ...
    protected function register_style_section_controls()
    {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Product Display', 'freska'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
            ...
            [
                'label' => __('Product Background Color', 'freska'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Price Typography', 'freska'),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Add to Cart Button Color', 'freska'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __('Add to Cart Button Hover Color', 'freska'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    ...
                    <div class="bt-hotspot-image">
                        <?php
                            if ($settings['hotspot_image']['id']) {
                                ...
                                echo '<img src="' . esc_url($settings['hotspot_image']['url']) . '" alt="' . esc_html__( 'Awaiting product image', 'freska' ) . '">';
                            }
                        ?>
                    </div>
