...
namespace FreskaElementorWidgets\Widgets\BrandSlider;
...
class Widget_BrandSlider extends Widget_Base
{
	...
	protected function register_content_section_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'title_field' => __('Brand Item', 'freska'),
			]
		);
	...
	protected function register_layout_section_controls()
	{
		...
		$this->add_control(
			'slider_continuous',
			[
				'label' => __('Continuous Sliding', 'freska'),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __('Yes', 'freska'),
				'label_off' => __('No', 'freska'),
				'default' => 'no',
				'description' => __('Enable continuous sliding animation', 'freska'),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __('Sliding Speed', 'freska'),
				'type' => Controls_Manager::NUMBER,
				'min' => 1000,
				'max' => 10000,
				'step' => 500,
				'default' => 3000,
				'description' => __('Set sliding speed in milliseconds', 'freska'),
				'condition' => [
		...
		$this->add_control(
			...
			[
				'label' => __('Sliding Direction', 'freska'),
	...
	protected function register_style_section_controls()
	{
		...
		$this->add_control(
			'svg_hover_color',
			[
				'label' => __('SVG Hover Color', 'freska'),
				'type' => Controls_Manager::COLOR,
			'selectors' => [
		...
		$this->add_control(
			'item_background',
			[
				'label' => __('Item Background', 'freska'),
				'type' => Controls_Manager::COLOR,
				'default' => '#f6f6f6',
			'selectors' => [
		...
		$this->add_control(
			'hover_background',
			[
				'label' => __('Hover Background', 'freska'),
				'type' => Controls_Manager::COLOR,
			'selectors' => [
									...
									<div class="bt-brand-slider--image">
										<?php if ($is_svg && !empty($image_url)) {
											...
											if (!empty($image_id)) {
												...
												echo '<img src="' . esc_url(Utils::get_placeholder_image_src()) . '" alt="' . esc_attr__('Brand Image', 'freska') . '">';
											}
										}
										?>
									</div>
...
<?php
			...
			echo '<div class="bt-brand-slider--empty">' . esc_html__('No brands found. Please add some brands in the widget settings.', 'freska') . '</div>';
		}
	}
