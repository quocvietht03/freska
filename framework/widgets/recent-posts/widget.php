...
namespace FreskaElementorWidgets\Widgets\RecentPosts;
...
class Widget_RecentPosts extends Widget_Base
{
	...
	protected function register_layout_section_controls()
	{
		...
		$this->add_control(
			'number_posts',
			[
				'label' => __('Number of Posts', 'freska'),
		...
		$this->add_control(
			'show_thumbnail',
			[
				'label' => __('Show Thumbnail', 'freska'),
	...
	protected function register_style_section_controls()
	{
		...
		$this->add_responsive_control(
			'item_space_between',
			[
				'label' => esc_html__('Space Between Posts', 'freska'),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'range' => [
					'px' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Thumbnail', 'freska'),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'show_thumbnail' => 'yes',
				],
