...
namespace FreskaElementorWidgets\Widgets\VerticalBannerSlider;
...
class Freska_VerticalBannerSlider extends Widget_Base
{
    ...
    {
        return __('Vertical Banner Slider', 'freska');
    }
    ...
    protected function register_layout_section_controls()
    {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => __('Banner Heading', 'freska'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'banner_heading' => __('Combo Meals', 'freska'),
                        'banner_link' => ['url' => '#'],
                    ],
                    [
                        'banner_heading' => __('Burger Line', 'freska'),
                        'banner_link' => ['url' => '#'],
                    ],
                    [
                        'banner_heading' => __('Fried Chicken', 'freska'),
                        'banner_link' => ['url' => '#'],
                    ],
                    [
                        'banner_heading' => __('Pizza Line', 'freska'),
                        'banner_link' => ['url' => '#'],
                    ],
                    [
                        'banner_heading' => __('Sides & Snacks', 'freska'),
                        'banner_link' => ['url' => '#'],
                    ],
                ],
        ...
        $this->add_control(
            'autoplay_speed',
            [
                'label' => __('Autoplay Speed', 'freska'),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Autoplay Only Mobile', 'freska'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'freska'),
                'label_off' => __('No', 'freska'),
                'default' => 'no',
    ...
    protected function register_style_section_controls()
    {
        ...
        $this->add_responsive_control(
            'banner_height',
            [
                'label' => __('Minimum Height', 'freska'),
        ...
        $this->add_control(
            'overlay_background',
            [
                'label' => __('Overlay Background', 'freska'),
        ...
        $this->add_responsive_control(
            'heading_gap',
            [
                'label' => __('Gap Between Headings', 'freska'),
                'type' => Controls_Manager::SLIDER,
                    ...
                    <div class="bt-banner-background <?php echo esc_attr($class_active); ?>" data-index="<?php echo esc_attr($index); ?>">
                        ...
                        <?php } else {
                            if (!empty($item['banner_image']['url'])) {
                                echo '<img src="' . esc_url($item['banner_image']['url']) . '" alt="' . esc_html__('Awaiting image', 'freska') . '">';
                            } else {
