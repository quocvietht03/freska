...
namespace FreskaElementorWidgets\Widgets\ProductTestimonialItem;
...
class Widget_ProductTestimonialItem extends Widget_Base
{
    ...
    {
        return __('Product Testimonial Item', 'freska');
    }
    ...
    protected function register_layout_section_controls()
    {
        ...
        $this->add_control(
			'image_position',
			[
				'label' => esc_html__( 'Image Position', 'freska' ),
                    ...
                    <div class="bt-cover-image">
                        ...
                        if (!empty($settings['testimonial_image']['id'])) {
                            ...
                            if (!empty($settings['testimonial_image']['url'])) {
                                echo '<img src="' . esc_url($settings['testimonial_image']['url']) . '" alt="' . esc_html__('Awaiting testimonial image', 'freska') . '">';
                            } else {
