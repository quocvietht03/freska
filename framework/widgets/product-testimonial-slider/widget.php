...
namespace FreskaElementorWidgets\Widgets\ProductTestimonialSlider;
...
class Widget_ProductTestimonialSlider extends Widget_Base
{
    ...
    {
        return __('Product Testimonial Slider', 'freska');
    }
    ...
    protected function register_layout_section_controls()
    {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'label_block' => true,
                'default' => __('What Our Customers Say', 'freska'),
                'placeholder' => __('Type your testimonial title', 'freska'),
            ]
        );
        ...
        $repeater->add_control(
            'testimonial_text',
            [
                'label' => __('Testimonial Text', 'freska'),
                'type' => Controls_Manager::TEXTAREA,
                'rows' => 5,
                'default' => __('This is a sample testimonial quote. It helps visualize how customer feedback will appear here.', 'freska'),
                'placeholder' => __('Type your testimonial text', 'freska'),
            ]
        );
        ...
        $repeater->add_control(
            'testimonial_author',
            [
                'label' => __('Author', 'freska'),
                'type' => Controls_Manager::TEXT,
                'default' => __('John Doe', 'freska'),
                'placeholder' => __('Enter author name', 'freska'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'testimonial_title' => __('Perfect neck support and versatile for lounging.', 'freska'),
                    ],
                    [
                        'testimonial_title' => __('Incredibly soft and holds its shape perfectly.', 'freska'),
                    ],
                    [
                        'testimonial_title' => __('Reduces neck pain while providing great comfort.', 'freska'),
                    ],
                    [
                        'testimonial_title' => __('Cozy and firm, ideal for back support and relaxation.', 'freska'),
                    ],
                ],
        ...
        $this->add_control(
            'enable_text_limit',
            [
                'label' => esc_html__( 'Enable Text Limit', 'freska' ),
        ...
        $this->add_control(
            'text_line_limit',
            [
                'label' => esc_html__( 'Text Limit Lines', 'freska' ),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Autoplay Delay', 'freska'),
        ...
        $this->add_control(
            'slider_loop',
            [
                'label' => __('Infinite Loop', 'freska'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'freska'),
                'label_off' => __('No', 'freska'),
                'default' => 'yes',
                'description' => __('Enable continuous loop mode', 'freska'),
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Gap between slides', 'freska'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range' => [
                    'px' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __('Hidden Arrow Mobile', 'freska'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'freska'),
                'label_off' => __('No', 'freska'),
                'default' => 'no',
        ...
        $this->add_control(
            ...
            [
                'label' => __('Mobile-Only Pagination', 'freska'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'freska'),
                'label_off' => __('No', 'freska'),
                'default' => 'no',
    ...
    protected function register_style_section_controls()
    {
        ...
        $this->add_responsive_control(
            'content_padding',
            [
                'label' => __('Content Padding', 'freska'),
        ...
        $this->add_control(
            'title_heading',
            [
                'label' => __('Testimonial Title', 'freska'),
        ...
        $this->add_control(
            'rating_empty_color',
            [
                'label' => __('Empty Star Color', 'freska'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Navigation Arrows', 'freska'),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'slider_arrows' => 'yes',
                ],
        ...
        $this->add_responsive_control(
            'arrow_left_position',
            [
                'label' => __('Left Arrow Position', 'freska'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', '%'],
                'range' => [
                    'px' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __('Right Arrow Position', 'freska'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', '%'],
                'range' => [
                    'px' => [
        ...
        $this->start_controls_section(
            'section_style_dots',
            [
                'label' => esc_html__('Navigation Dots', 'freska'),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'slider_dots' => 'yes',
                ],
    ...
    protected function render()
    {
        ...
        $slider_settings = freska_elwg_get_slider_settings($settings, $breakpoints);
                                            ...
                                            <div class="bt-cover-image">
                                                ...
                                                if (!empty($item['testimonial_image']['id'])) {
                                                    ...
                                                    if (!empty($item['testimonial_image']['url'])) {
                                                        echo '<img src="' . esc_url($item['testimonial_image']['url']) . '" alt="' . esc_html__('Awaiting testimonial image', 'freska') . '">';
                                                    } else {
                                                        echo '<img src="' . esc_url(Utils::get_placeholder_image_src()) . '" alt="' . esc_html__('Awaiting testimonial image', 'freska') . '">';
                                                    }
                                                }
                                                ?>
                                            </div>
