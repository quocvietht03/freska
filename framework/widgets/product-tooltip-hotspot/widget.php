...
namespace FreskaElementorWidgets\Widgets\ProductTooltipHotspot;
...
class Widget_ProductTooltipHotspot extends Widget_Base
{
    ...
    {
        return __('Product Tooltip Hotspot', 'freska');
    }
    ...
    protected function register_layout_section_controls()
    {
        ...
        $this->add_control(
            'show_mobile_image',
            [
                'label' => __('Show Mobile Image', 'freska'),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Mobile Image', 'freska'),
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => Utils::get_placeholder_image_src(),
                ],
                'description' => __('Choose a different image to display on mobile devices', 'freska'),
                'condition' => [
        ...
        $this->add_control(
            'hotspot_point_style',
            [
                'label' => __('Hotspot Point Style', 'freska'),
                'type' => Controls_Manager::SELECT,
                'default' => 'default',
                'options' => [
                    'default' => __('Default', 'freska'),
                    'number' => __('Number', 'freska'),
                ],
            ]
        );
        $this->add_control(
            'tooltip_layout',
            [
                'label' => __('Layout Tooltip', 'freska'),
                'type' => Controls_Manager::SELECT,
                'default' => 'default',
                'options' => [
                    'default' => __('Default', 'freska'),
                    'style1' => __('Style 1', 'freska'),
                ],
            ]
        );
        $this->add_control(
            'show_quick_view',
            [
                'label' => __('Show Quick View', 'freska'),
                'type' => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            'hotspot_align',
            [
                'label' => __('Hotspot Alignment', 'freska'),
                'description' => __('Choose how to align the hotspot elements within the container', 'freska'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'flex-start' => __('Start', 'freska'),
                    'center' => __('Center', 'freska'),
                    'flex-end' => __('End', 'freska'),
                    'stretch' => __('Stretch', 'freska'),
                ],
                'default' => 'center',
                'selectors' => [
        ...
        $this->add_control(
            'hotspot_full_width',
            [
                'label' => __('Hotspot Full Width', 'freska'),
        ...
        $this->add_control(
            'show_add_to_cart',
            [
                'label' => __('Show Set to Cart', 'freska'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'freska'),
                'label_off' => __('No', 'freska'),
                'default' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => __('Show Content or Image', 'freska'),
                'type' => Controls_Manager::SELECT,
                'default' => 'image',
                'options' => [
                    'content' => __('Content', 'freska'),
                    'image' => __('Image', 'freska'),
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __('Slider Sub Heading', 'freska'),
                'label_block' => true,
                'condition' => [
                    'show_slider' => 'yes',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'default' => __('Slider Heading', 'freska'),
                'label_block' => true,
                'condition' => [
                    'show_slider' => 'yes',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __('Slider description text goes here', 'freska'),
                'label_block' => true,
                'condition' => [
                    'show_slider' => 'yes',
                ],
        ...
        $this->add_responsive_control(
            'slider_spacebetween',
            [
                'label' => __('Slider SpaceBetween', 'freska'),
                'type' => Controls_Manager::NUMBER,
                'default' => 20,
                'min' => 0,
                'max' => 100,
    ...
    protected function register_style_section_controls()
    {
        ...
        $this->add_responsive_control(
            'content_spacing',
            [
                'label' => __('Content Spacing', 'freska'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', 'em', '%'],
                'range' => [
                    'px' => [
        ...
        $this->add_responsive_control(
            'heading_padding',
            [
                'label' => __('Heading Padding', 'freska'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
        ...
        $this->add_responsive_control(
            'sub_heading_padding',
            [
                'label' => __('Sub Heading Padding', 'freska'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __('Sub Heading Max Width', 'freska'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', '%'],
                'range' => [
                    'px' => [
        ...
        $this->add_responsive_control(
            'description_padding',
            [
                'label' => __('Description Padding', 'freska'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __('Description Max Width', 'freska'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', '%'],
                'range' => [
                    'px' => [
                                            ...
                                            <div class="bt-product-content">
                                                ...
                                                <?php if ($show_quickview) : ?>
                                                    <a class="btn bt-product-quick-view-btn" href="#" data-id="<?php echo esc_attr($item['id_product']); ?>">
                                                        <?php esc_html_e('Quick View', 'freska'); ?>
                                                    </a>
                                                <?php endif; ?>
                                            </div>
                                        </div>
