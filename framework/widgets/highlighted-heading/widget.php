...
namespace FreskaElementorWidgets\Widgets\HighlightedHeading;
...
class Widget_HighlightedHeading extends Widget_Base
{
	...
	{
		return __('Highlighted Heading', 'freska');
	}
	...
	protected function register_content_section_controls()
	{
		...
		$this->add_control(
			'before_text',
			[
				'label'       => esc_html__('Before Text', 'freska'),
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'default'     => esc_html__('This is the heading', 'freska'),
			]
		);
		...
		$this->add_control(
			'highlighted_text',
			[
				'label'       => esc_html__('Highlighted Text', 'freska'),
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'default'     => esc_html__('Highlighted', 'freska'),
			]
		);
		...
		$this->add_control(
			'after_text',
			[
				'label'       => esc_html__('After Text', 'freska'),
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'default'     => '',
			]
	...
	protected function register_style_content_section_controls()
	{
		...
		$this->add_control(
			...
			[
				'label' => __('Highlighted Text', 'freska'),
