...
namespace FreskaElementorWidgets\Widgets\SiteNotification;
...
class Widget_SiteNotification extends Widget_Base
{
    ...
    {
        return __('Site Notification', 'freska');
    }
    ...
    protected function register_layout_section_controls()
    {
        $this->start_controls_section(
            'section_slider',
            [
                'label' => __('Notification', 'freska'),
            ]
        );
        $this->add_control(
            'show_icon',
            [
                'label' => __('Show Icon', 'freska'),
        ...
        $this->add_control(
            'slider_autoplay',
            [
                'label' => __('Notification Autoplay', 'freska'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'freska'),
                'label_off' => __('No', 'freska'),
                'default' => 'no',
        ...
        $this->add_control(
            ...
            [
                'label' => __('Notification Delay', 'freska'),
                'type' => Controls_Manager::NUMBER,
                'default' => 3000,
                'min' => 1000,
                'max' => 10000,
                'step' => 500,
                'description' => __('Delay between notification in milliseconds', 'freska'),
                'condition' => [
                    'slider_autoplay' => 'yes',
                ],
            ]
    ...
    protected function register_style_section_controls()
    {
        ...
        $this->add_control(
            'link_hover_color',
            [
                'label' => __('Link Hover Color', 'freska'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            'nav_color',
            [
                'label' => __('Navigation Color', 'freska'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
                                    ...
                                    <div class="bt-site-notification--item">
                                        <?php if ($settings['show_icon'] == 'yes') :
                                            if (!empty($item['icon']['id'])) {
                                                ...
                                                echo '<img src="' . esc_url(Utils::get_placeholder_image_src()) . '" alt="' . esc_html__('Awaiting icon', 'freska') . '">';
                                            }
                                        endif; ?>
