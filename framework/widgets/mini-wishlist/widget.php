...
namespace FreskaElementorWidgets\Widgets\MiniWishlist;
...
class Widget_MiniWishlist extends Widget_Base
{
	...
	{
		return __('Mini Wishlist', 'freska');
	}
	...
	protected function register_content_section_controls()
	{
		...
		$this->add_control(
			'wishlist_mini_icon',
			[
				'label' => esc_html__('Icon Wishlist', 'freska'),
	...
	protected function register_style_content_section_controls()
	{
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Content Wishlist', 'freska'),
		...
		$this->add_control(
			'number_wishlist',
			[
				'label' => __('Number Wishlist', 'freska'),
				'type' => Controls_Manager::HEADING,
			]
		);
		$this->add_control(
