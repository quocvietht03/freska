...
namespace FreskaElementorWidgets\Widgets\SearchProduct;
...
class Widget_SearchProduct extends Widget_Base
{
	...
	{
		return __('Search Product', 'freska');
	}
	...
	protected function register_query_section_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'default' => __('What are you looking for today?', 'freska'),
		...
		$this->add_control(
			'autocomplete_limit',
			[
				'label' => __('Autocomplete Products Limit', 'freska'),
				'type' => Controls_Manager::NUMBER,
				'default' => 5,
				'min' => -1,
				'max' => 50,
				'step' => 1,
				'description' => __('Number of products to show in autocomplete results. Use -1 for unlimited.', 'freska'),
				'condition' => [
		...
		$this->add_control(
			'add_to_cart_style',
			[
				'label' => __('Add to Cart Style', 'freska'),
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => __('Enter button text', 'freska'),
				'description' => __('Text shown when search has results', 'freska'),
				'condition' => [
					'enable_autocomplete' => 'yes',
				],
			]
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => __('Enter button text', 'freska'),
				'description' => __('Text shown when search has no results', 'freska'),
				'condition' => [
					'enable_autocomplete' => 'yes',
				],
			]
	...
	protected function register_style_section_controls()
	{
		...
		$this->add_control(
			...
			[
				'label' => __('Placeholder Color', 'freska'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
