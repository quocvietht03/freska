...
$is_category_page = freska_is_category_archive_page();
...
<div class="bt-product-sidebar"
  <?php if (freska_is_category_archive_page()) { ?>data-is-category-page="1" <?php } ?>
  ...
  <form class="bt-product-filter-form" action="" method="get">
    <div class="bt-form-action">
      <h2 class="bt-form-title">
        ...
        <span><?php echo esc_html_e('Filters', 'freska') ?></span>
      </h2>
    ...
    <div class="bt-product-filter-fields">
      ...
      ?>
              <div class="bt-form-field bt-field-type-search">
                <input type="text" name="search_keyword" value="<?php if (isset($_GET['search_keyword'])) echo esc_attr($_GET['search_keyword']); ?>" placeholder="<?php esc_attr_e('Search …', 'freska'); ?>" autocomplete="off">
                <a href="#">
            ...
            case 'categories':
              $field_name = __('Product Categories', 'freska');
              ...
              freska_product_field_radio_html('product_cat', $field_name, $field_value);
              break;
            ...
            case 'price':
              ...
              freska_product_field_price_slider($field_title, $field_min_value, $field_max_value);
              break;
        ...
        <?php
            ...
            default:
              ...
              if (strpos($filter_type, 'pa_') === 0 && taxonomy_exists($filter_type)) {
                ...
                if (function_exists('freska_is_attribute_enabled_in_search') && freska_is_attribute_enabled_in_search($filter_type)) {
                  $attribute_type = function_exists('freska_get_attribute_type') ? freska_get_attribute_type($filter_type) : 'select';
                  ...
                  if ($attribute_type === 'color') {
                    freska_product_field_multiple_color_html($filter_type, $field_name, $field_value);
                  } else {
                    freska_product_field_multiple_html($filter_type, $field_name, $field_value);
                  }
                }
              }
              break;
      ...
      <?php
        ...
        if (!empty($enabled_attributes)) {
          foreach ($enabled_attributes as $attr_data) {
            ...
            if ($attribute_type === 'image') {
              freska_product_field_multiple_html($taxonomy, $field_name, $field_value);
            } else {
              freska_product_field_multiple_html($taxonomy, $field_name, $field_value);
            }
          }
        ...
        if (!empty($color_taxonomies)) {
          foreach ($color_taxonomies as $color_taxonomy) {
            $field_name = function_exists('wc_attribute_label') ? wc_attribute_label($color_taxonomy) : __('Colors', 'freska');
            $field_value = (isset($_GET[$color_taxonomy])) ? $_GET[$color_taxonomy] : '';
            freska_product_field_multiple_color_html($color_taxonomy, $field_name, $field_value);
          }
        }
      ...
      <div class="bt-form-button-results">
        <a href="#" class="bt-reset-filter-product-btn disable"><?php echo esc_html__('Clear All Filters', 'freska'); ?></a>
